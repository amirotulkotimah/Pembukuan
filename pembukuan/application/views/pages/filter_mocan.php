		...
		<div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
			...
			<div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
				...
				<div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
					<!--begin::Title-->
					<h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Laporan Mocan</h1>
					<!--end::Title-->
					<!--begin::Breadcrumb-->
					<ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
						...
						<!--begin::Item-->
						<li class="breadcrumb-item text-muted">
							<a href="<?php echo site_url('mocan_c');?>" class="text-muted text-hover-primary">Laporan Mocan</a>
						</li>
						<!--end::Item-->
						<!--begin::Item-->
						<li class="breadcrumb-item">
				...
				<div class="card card-flush">
					<div class="card-header align-items-center py-5 gap-2 gap-md-5">
						...
						<div class="card-toolbar flex-row-fluid justify-content-end gap-5">
							<a href="<?php echo site_url('mocan_c');?>"><button type="button" class="btn btn-primary">Reset</button></a>
						</div>
					<!--<a href="#" data-bs-toggle="modal" data-bs-target="#tambah" class="btn btn-primary">Tambah Data</a>-->
				</div>
					<!--begin::Card body-->
					<div class="card-body pt-0">
						<form method="post" action="<?php echo site_url('mocan_c/delete') ?>">
							<!--begin::Table-->
									...
									<tr>
										...
										<td>
											<div class="form-check form-check-sm form-check-custom form-check-solid">
												<input class="form-check-input" type="checkbox" name="id_mocan[]" value='<?php echo $baris->id_mocan; ?>'/>
											</div>
										</td>
											...
											<a href="#" class="btn btn-sm btn-light btn-active-light-primary" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">Actions
												...
												<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
													...
													<div class="menu-item px-3">
														<a href="#" class="menu-link px-3" data-kt-ecommerce-category-filter="delete_row" data-bs-toggle="modal" data-bs-target="#detail<?php echo $baris->id_mocan; ?>">Detail</a>
													</div>
													<!--end::Menu item-->
													<!--begin::Menu item-->
													<div class="menu-item px-3">
														<a href="#" class="menu-link px-3" data-bs-toggle="modal" data-bs-target="#edit<?php echo $baris->id_mocan; ?>">Edit</a>
													</div>
													<!--end::Menu item-->
													<!--begin::Menu item-->
													<div class="menu-item px-3">
														<a href="#" class="menu-link px-3" data-kt-ecommerce-category-filter="delete_row" data-bs-toggle="modal" data-bs-target="#delete<?php echo $baris->id_mocan; ?>">Delete</a>
													</div>
													<!--end::Menu item-->
												</div>
												<!--end::Menu-->
...
<form class="user" action="<?php echo site_url('mocan_c/edit/');?>" method="post" enctype="multipart/form-data">
<div class="modal fade" tabindex="-1" id="edit<?php echo $baris->id_mocan; ?>">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
            	 	<input type="hidden" value="<?php echo $baris->id_mocan;?>" name="id_mocan">
                ...
                <div class="form-group">
                	...
                	<select class="form-control" id="kategori2<?php echo $baris->id_mocan; ?>" name="kategori" >
                ...
                <div class="form-group">
                	<label for="exampleFormControlInput1" class="required form-label">Jenis Uang:</label>
                		<select name="jenis_uang" class="jenis_uang2<?php echo $baris->id_mocan; ?> form-control">
                ...
                <div class="form-group">
                	...
                	<input type="text" placeholder=""  class="form-control" id="debit" name="debit" value="<?php echo $baris->debit;?>">
                	<span class="font-13 text-muted"> </span>
                </div>
                <br>
                <div class="form-group">
                	<label for="exampleFormControlInput1" class="required form-label">Kredit</label>
                	<input type="text" placeholder=""  class="form-control" id="kredit" name="kredit" value="<?php echo $baris->kredit;?>">
                	<span class="font-13 text-muted"></span>
                </div>
                <br>
                <div class="form-group">
            ...
            <div class="modal-footer">
              ...
              <script type="text/javascript">
				...
				$(document).ready(function(){
					$('#kategori2<?php echo $baris->id_mocan; ?>').change(function(){
						var id_kategori=$(this).val();
						$.ajax({
							url : "<?php echo site_url();?>/mocan_c/get_subkategori",
							method : "POST",
							...
							success: function(data){
								...
								$('.jenis_uang2<?php echo $baris->id_mocan; ?>').html(html);
							}
						});
					});
				});
...
<?php foreach($user as $baris): ?>
<div class="modal fade" tabindex="-1" id="detail<?php echo $baris->id_mocan; ?>">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
...
<?php foreach($user as $baris): ?>
<form class="user" action="<?php echo site_url('mocan_c/hapus_data/');?>" method="post" enctype="multipart/form-data">
	<div class="modal fade" tabindex="-1" id="delete<?php echo $baris->id_mocan; ?>">
