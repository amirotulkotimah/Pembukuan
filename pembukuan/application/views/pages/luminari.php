		...
		<div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
			...
			<div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
				...
				<div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
					<!--begin::Title-->
					<h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Laporan Luminari</h1>
					<!--end::Title-->
					<!--begin::Breadcrumb-->
					<ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
						...
						<!--end::Item-->
						<!--begin::Item-->
						<li class="breadcrumb-item text-muted">Laporan Luminari</li>
						<!--end::Item-->
					</ul>
					<!--end::Breadcrumb-->
				</div>
					...
					<div class="m-0">
						...
						<a href="#" class="btn btn-sm btn-flex bg-body btn-color-gray-700 btn-active-color-primary fw-bold" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">
							...
							<div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_63d12d561698e">
								...
								<form action="<?php echo site_url('luminari_c/filter'); ?>" method="get" >
									<!--end::Header-->
			...
			<div id="kt_app_content_container" class="app-container container-xxl">
				...
				<div class="card card-flush">
					...
					<div class="card-body pt-0">
						<form method="post" action="<?php echo site_url('luminari_c/delete') ?>">
							<!--begin::Table-->
							<table class="table align-middle table-row-dashed fs-6 gy-5" id="table">
								...
								<?php 
								//$no = 1; //no default 1
								foreach ($luminari->result() as $baris) { //
								?>
									...
									<tr>
										...
										<td>
											<div class="form-check form-check-sm form-check-custom form-check-solid">
												<input class="form-check-input" type="checkbox" name="id_luminari[]" value='<?php echo $baris->id_luminari; ?>'/>
											</div>
										</td>
										<!--end::Checkbox-->
										<!--begin::Type=-->
											...
											<a href="#" class="btn btn-sm btn-light btn-active-light-primary" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">Actions
												...
												<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
													...
													<div class="menu-item px-3">
														<a href="#" class="menu-link px-3" data-kt-ecommerce-category-filter="delete_row" data-bs-toggle="modal" data-bs-target="#detail<?php echo $baris->id_luminari; ?>">Detail</a>
													</div>
													<!--end::Menu item-->
													<!--begin::Menu item-->
													<div class="menu-item px-3">
														<a href="#" class="menu-link px-3" data-bs-toggle="modal" data-bs-target="#edit<?php echo $baris->id_luminari; ?>">Edit</a>
													</div>
													<!--end::Menu item-->
													<!--begin::Menu item-->
													<div class="menu-item px-3">
														<a href="#" class="menu-link px-3" data-kt-ecommerce-category-filter="delete_row" data-bs-toggle="modal" data-bs-target="#delete<?php echo $baris->id_luminari; ?>">Delete</a>
													</div>
													<!--end::Menu item-->
												</div>
												<!--end::Menu-->
...
<form class="user" action="<?php echo site_url('luminari_c/input/');?>" method="post" enctype="multipart/form-data">
            ...
            <div class="modal-body">
                <div class="form-group">
                	...
                	<!--<div class="form-group">
                		...
                		<div>
                			<input type="file" accept="image/jpeg, image/png" class="form-control" id="filefoto" name="filefoto" value="">
                			<span class="font-13 text-muted"></span>
                		</div>
                	</div>-->
                	<div class="form-group">
            ...
            <div class="modal-footer">
				...
				$(document).ready(function(){
					$('#kategori').change(function(){
						...
						$.ajax({
							url : "<?php echo site_url();?>/luminari_c/get_subkategori",
							method : "POST",
...
<form class="user" action="<?php echo site_url('luminari_c/edit/');?>" method="post" enctype="multipart/form-data">
<div class="modal fade" tabindex="-1" id="edit<?php echo $baris->id_luminari; ?>">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">
            	 	<input type="hidden" value="<?php echo $baris->id_luminari;?>" name="id_luminari">
                ...
                <div class="form-group">
                	<label for="exampleFormControlInput1" class="required form-label">Kategori</label>
                	<select class="form-control" id="kategori2<?php echo $baris->id_luminari; ?>" name="kategori" >
                ...
                <div class="form-group">
                	<label for="exampleFormControlInput1" class="required form-label">Jenis Uang:</label>
                		<select name="jenis_uang" class="jenis_uang2<?php echo $baris->id_luminari; ?> form-control">
            ...
            <div class="modal-footer">
              ...
              <script type="text/javascript">
				...
				$(document).ready(function(){
					$('#kategori2<?php echo $baris->id_luminari; ?>').change(function(){
						var id_kategori=$(this).val();
						$.ajax({
							url : "<?php echo site_url();?>/luminari_c/get_subkategori",
							method : "POST",
							...
							success: function(data){
								...
								$('.jenis_uang2<?php echo $baris->id_luminari; ?>').html(html);
							}
						});
					});
				});
...
<?php foreach($user as $baris): ?>
<div class="modal fade" tabindex="-1" id="detail<?php echo $baris->id_luminari; ?>">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
...
<?php foreach($user as $baris): ?>
<form class="user" action="<?php echo site_url('luminari_c/hapus_data/');?>" method="post" enctype="multipart/form-data">
	<div class="modal fade" tabindex="-1" id="delete<?php echo $baris->id_luminari; ?>">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
